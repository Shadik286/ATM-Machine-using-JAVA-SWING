...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(686, 731));
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
        ...
        try{
            if(AcNumber.getText().equals(atm.Acc)){
                ...
                int response = JOptionPane.showConfirmDialog(null, "Wrong AC Number, Try Again", "Try Again", JOptionPane.OK_CANCEL_OPTION);
