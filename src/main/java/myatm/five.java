...
public class five extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        wlctext.setText("Welcome to Shadik Rahman");
        ...
        setSize(new java.awt.Dimension(726, 717));
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
         try{
            atm.bal = Integer.parseInt(amount.getText()); 
            if(atm.bal<atm.Balance){
            atm.Balance = atm.Balance - atm.bal;  
            ball blfrm = new ball();
